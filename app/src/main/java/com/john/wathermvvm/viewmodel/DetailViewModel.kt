...
constructor(
    ...
    private val _forecastNetworkState: MutableLiveData<NetworkDataState<List<City>>> = MutableLiveData()
    ...
    val forecastNetworkState: LiveData<NetworkDataState<List<City>>>
