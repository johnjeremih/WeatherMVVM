package com.john.weathermvvm.view.adapters.city
...
import com.john.weathermvvm.databinding.AdapterCityItemBinding
...
class CityViewHolder(private val binding: AdapterCityItemBinding) :
    ...
    companion object {
        fun create(parent: ViewGroup): CityViewHolder {
            val binding = AdapterCityItemBinding.inflate(
